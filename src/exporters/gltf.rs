  ...
  "buffers": [
    {{
      ...
      "byteLength": {}
        ...
        // Min bounds
        calculate_min_x(model), calculate_min_y(model), calculate_min_z(model),
        
        // Max bounds
        calculate_max_x(model), calculate_max_y(model), calculate_max_z(model),
