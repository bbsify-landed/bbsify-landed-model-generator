...
fn test_export_transformed_model() {
    ...
    cube.export_obj("tests/output/transformed_cube.obj").unwrap();
    cube.export_stl("tests/output/transformed_cube.stl").unwrap();
    cube.export_gltf("tests/output/transformed_cube.gltf").unwrap();
